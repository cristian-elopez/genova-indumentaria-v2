...
import { ColumnsContein, FooterColumnsContainer, FooterContainerStyled, InfoCopyrigthStyled, LinkContainerStyled, LogoStyled, TittleColumnFotter } from "./FooterStyles"
        ...
        <FooterContainerStyled>
            <FooterColumnsContainer>
                <ColumnsContein>
                    ...
                    <Link to='/help'>
                        <LinkContainerStyled> ¿Como realizar un pedido? </LinkContainerStyled>
                    </Link>
                    <Link to='/help'>
            ...
            <InfoCopyrigthStyled>
                © 2024 Génova Indumentaria. Todos los derechos reservados - Diseñada por <strong>Cristian Lopez</strong>
            </InfoCopyrigthStyled>
        </FooterContainerStyled>
    )
};